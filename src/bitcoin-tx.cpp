...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s albertcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  albertcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded albertcoin transaction") + "\n" +
              "  albertcoin-tx [options] -create [commands]   " + _("Create hex-encoded albertcoin transaction") + "\n" +
              "\n";
