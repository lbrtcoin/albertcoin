...
const char * const BITCOIN_CONF_FILENAME = "albertcoin.conf";
const char * const BITCOIN_PID_FILENAME = "albertcoin.pid";
...
#else
    const char* pszModule = "albertcoin";
#endif
    if (pex)
        return strprintf(
