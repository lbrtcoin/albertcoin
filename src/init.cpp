...
void Shutdown()
{
    ...
    RenameThread("albertcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/albertcoin-project/albertcoin>";
    const std::string URL_WEBSITE = "<https://albertcoin.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("albertcoin-loadblk");
    CImportingNow imp;
