...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.albertcoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("albertcointools.com", "dnsseed.albertcointools.com"));
        vSeeds.push_back(CDNSSeedData("albertcoinpool.org", "dnsseed.albertcoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("albertcointools.com", "testnet-seed.albertcointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.albertcoin.loshan.co.uk", true));
